...
import { HistoryTranslation } from '../reducer';
...
export class TranslationBase extends React.Component<InternalProps, State> {
    ...
    handleStatusChange = (event: React.MouseEvent<HTMLButtonElement>) => {
                        ...
                        <div className='content'>
                            <header className='clearfix'>
                                ...
                                <menu className='toolbar'>
                                    ...
                                    {translation.approved ? ( // Unapprove Button
                                    ...
                                    {translation.rejected ? ( // Unreject Button
                                        canReject ? (
                                            <Localized
