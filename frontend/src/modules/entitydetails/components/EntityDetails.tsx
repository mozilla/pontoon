...
import { ChangeOperation, HistoryState } from 'modules/history';
import { MachineryState } from 'modules/machinery';
import { LocalesState } from 'modules/otherlocales';
...
export class EntityDetailsBase extends React.Component<InternalProps, State> {
    ...
    addComment = (comment: string, translation: number | null | undefined) => {
        const { parameters, pluralForm, dispatch } = this.props;
        dispatch(
