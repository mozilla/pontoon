...
def add_to_system_projects(apps, schema_editor):
    ...
    for locale in project.locales.all():
        ...
        locale.approved_strings = (
            F("approved_strings") - project_locale.approved_strings
        )
        locale.fuzzy_strings = F("fuzzy_strings") - project_locale.fuzzy_strings
        locale.unreviewed_strings = (
            F("unreviewed_strings") - project_locale.unreviewed_strings
        )
        locale.save(
            update_fields=[
                "total_strings",
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_to_system_projects, remove_from_system_projects,),
    ]
