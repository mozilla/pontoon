...
urlpatterns = patterns('',
    ...
    url(r'^approve-translation/', views.approve_translation, name='pontoon.approve_translation'),
    url(r'^delete-translation/', views.delete_translation, name='pontoon.delete_translation'),
