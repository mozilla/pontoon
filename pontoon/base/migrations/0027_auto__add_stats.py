...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Stats'
        db.create_table('base_stats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Resource'])),
            ('locale', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Locale'])),
            ('translated_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('approved_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('fuzzy_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('base', ['Stats'])


    def backwards(self, orm):
        # Deleting model 'Stats'
        db.delete_table('base_stats')
