...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Locale.nplurals'
        db.add_column('base_locale', 'nplurals',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Locale.plural_rule'
        db.add_column('base_locale', 'plural_rule',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Locale.nplurals'
        db.delete_column('base_locale', 'nplurals')

        # Deleting field 'Locale.plural_rule'
        db.delete_column('base_locale', 'plural_rule')
