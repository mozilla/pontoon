...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.info_locales'
        db.delete_column('base_project', 'info_locales')

        # Deleting field 'Project.info_metrics'
        db.delete_column('base_project', 'info_metrics')

        # Deleting field 'Project.info_audience'
        db.delete_column('base_project', 'info_audience')


    def backwards(self, orm):
        # Adding field 'Project.info_locales'
        db.add_column('base_project', 'info_locales',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Project.info_metrics'
        db.add_column('base_project', 'info_metrics',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Project.info_audience'
        db.add_column('base_project', 'info_audience',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
