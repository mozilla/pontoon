...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.format'
        db.add_column('base_resource', 'format',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


        # Changing field 'Stats.approved_count'
        db.alter_column('base_stats', 'approved_count', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Stats.translated_count'
        db.alter_column('base_stats', 'translated_count', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Stats.fuzzy_count'
        db.alter_column('base_stats', 'fuzzy_count', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Deleting field 'Resource.format'
        db.delete_column('base_resource', 'format')


        # Changing field 'Stats.approved_count'
        db.alter_column('base_stats', 'approved_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Stats.translated_count'
        db.alter_column('base_stats', 'translated_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Stats.fuzzy_count'
        db.alter_column('base_stats', 'fuzzy_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'base.entity': {
            ...
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.Resource']"}),
        ...
        'base.resource': {
            ...
            'entity_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'format': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'base.stats': {
            ...
            'approved_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'fuzzy_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'locale': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.Locale']"}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.Resource']"}),
            'translated_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        'base.subpage': {
