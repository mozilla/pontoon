        ...
        const steps = [
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--intro-content">
                        <p>Pontoon is a localization platform by Mozilla, used to localize
                        Firefox and various other projects at Mozilla and other organizations.</p>
                    </Localized>
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--main-toolbar-content">
                        <p>The main toolbar located on top of the screen shows the language,
                    ...
                    <Localized id="interactivetour-InteractiveTour--main-toolbar-footer">
                        <p>On the right hand side, logged in users can access notifications
                        and settings.</p>
                    </Localized>
                </div>,
                style: {
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--string-list-content">
                        <p>The sidebar displays a list of strings in the current
                    ...
                    <Localized id="interactivetour-InteractiveTour--string-list-footer">
                        <p>On top of the list is a search box, which allows you to
                        search source strings, translations, comments and string IDs.</p>
                    </Localized>
                </div>,
                style: {
                    margin: "15px",
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--filters-content">
                        <p>Strings can also be filtered by their status, translation time,
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--editor-content">
                        <p>Clicking a string in the list opens it in the editor. On top of
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--submit-content-unauthenticated">
                        <p>A user needs to be logged in to be able to submit translations.
                        Non-authenticated users will see a link to Sign in instead of the
                        translation toolbar with a button to save translations.</p>
                    </Localized>
                    : !this.props.isTranslator ?
                    <Localized id="interactivetour-InteractiveTour--submit-content-contributor">
                        <p>When a translator is in Suggest Mode, or doesn’t have permission
                        ...
                        translation input and click SUGGEST.</p>
                    </Localized>
                    :
                    <Localized id="interactivetour-InteractiveTour--submit-content-translator">
                        <p>If a translator has permission to add translations directly,
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--history-content">
                        <p>All suggestions and translations submitted for the current
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--machinery-content">
                        <p>The Machinery tab shows automated translation suggestions from
            ...
            },
            {
                ...
                content: <div>
                    ...
                    <Localized id="interactivetour-InteractiveTour--locales-content">
                        <p>Sometimes it’s useful to see general style choices by other
