...
4.  Fill the project creation form as follows:
    ...
    * **Repositories -> URL**: <https://github.com/mozilla-l10n/pontoon-test>
...
|---------------------------------------------------------------------|--------|------------------------|------------------|------------------------------------------|
| ![image0](https://avatars2.githubusercontent.com/u/626716?s=32&v=4) | Matjaž | Pontoon Core Developer | mathjazz         | [mathjazz](https://github.com/mathjazz/) |
| ![image1](https://avatars3.githubusercontent.com/u/617000?s=32&v=4) | Eemeli | Pontoon Core Developer | eemeli           | [eemeli](https://github.com/eemeli/)     |
