...
export default class Metadata extends React.Component<Props, State> {
  ...
  handleClickOnPlaceable: (e: React.MouseEvent<HTMLParagraphElement>) => void =
  ...
  renderComment(entity: Entity): React.ReactNode {
    ...
    return (
      <Localized id='entitydetails-Metadata--comment' attrs={{ title: true }}>
    ...
    return (
      <div className='metadata'>
        {!showContextIssueButton ? null : (
          <ContextIssueButton openTeamComments={this.openTeamComments} />
        )}
