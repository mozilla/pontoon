...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.entity_count'
        db.add_column('base_resource', 'entity_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.entity_count'
        db.delete_column('base_resource', 'entity_count')
