...
def entity_factory():
    ...
    return functools.partial(
        _factory, Model=Entity, instance_attrs=instance_attrs
    )
...
def locale_factory():
    ...
    return functools.partial(
        _factory, Model=Locale, instance_attrs=instance_attrs
    )
...
def project_factory():
    ...
    return functools.partial(
        _factory, Model=Project, instance_attrs=instance_attrs
    )
...
def resource_factory():
    ...
    return functools.partial(
        _factory, Model=Resource, instance_attrs=instance_attrs
    )
...
def translation_factory():
    ...
    return functools.partial(
        _factory, Model=Translation, instance_attrs=instance_attrs
    )
