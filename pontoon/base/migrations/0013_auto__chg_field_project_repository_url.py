...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('base_project', 'repository_url', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Project.repository_url'
        db.alter_column('base_project', 'repository_url', self.gf('django.db.models.fields.URLField')(max_length=200))
