...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entity.resource'
        db.alter_column('base_entity', 'resource_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['base.Resource']))

    def backwards(self, orm):

        # Changing field 'Entity.resource'
        db.alter_column('base_entity', 'resource_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Resource'], null=True))
