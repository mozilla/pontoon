...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entity.resource'
        db.add_column('base_entity', 'resource',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Resource'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entity.resource'
        db.delete_column('base_entity', 'resource_id')
