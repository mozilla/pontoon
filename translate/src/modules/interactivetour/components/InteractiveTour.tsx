        ...
        content: (
          <div>
            ...
            <Localized id='interactivetour-InteractiveTour--main-toolbar-content'>
              <p>
                The main toolbar located on top of the screen shows the
                language, project and resource currently being localized. You
                can also see the progress of your current localization and
          ...
          <div>
            ...
            {!this.props.user.isAuthenticated ? (
              <Localized id='interactivetour-InteractiveTour--submit-content-unauthenticated'>
                <p>
                  A user needs to be logged in to be able to submit
                  translations. Non-authenticated users will see a link to Sign
                  in instead of the translation toolbar with a button to save
                  translations.
                </p>
              </Localized>
              ...
              <Localized id='interactivetour-InteractiveTour--submit-content-contributor'>
                <p>
                  When a translator is in Suggest Mode, or doesn’t have
                  permission to submit translations directly, a blue SUGGEST
                  button will appear in the translation toolbar. To make a
                  suggestion, type it in the translation input and click
                  SUGGEST.
                </p>
              </Localized>
            ) : (
          ...
          <div>
            ...
            <Localized id='interactivetour-InteractiveTour--terms-content'>
              <p>
                ...
                source string, along with their definitions, usage examples,
                part of speech and translations. By clicking on a term, its
        ...
        content: (
          <div>
            ...
            <Localized id='interactivetour-InteractiveTour--comments-content'>
              <p>
                In the Comments tab you can discuss how to translate content
                with your fellow team members. It’s also the place where you can
