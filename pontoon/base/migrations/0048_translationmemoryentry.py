        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.ForeignKey(
                    on_delete=django.db.models.deletion.SET_NULL, to='base.Entity', null=True)),
                ('locale', models.ForeignKey(to='base.Locale')),
                ('translation', models.ForeignKey(related_name='memory_entries',
                                                  on_delete=django.db.models.deletion.SET_NULL, to='base.Translation', null=True)),
            ],
        ),
