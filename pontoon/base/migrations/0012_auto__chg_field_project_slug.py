...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('base_project', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Project.slug'
        db.alter_column('base_project', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
