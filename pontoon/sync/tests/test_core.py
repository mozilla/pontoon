...
from pontoon.sync.core import (
    ...
    update_translated_resources_config,
    update_translated_resources_no_config,
    update_translations,
)
...
class UpdateTranslatedResourcesTests(FakeCheckoutTestCase):
    @patch('pontoon.sync.core.update_translated_resources_no_config')
    @patch('pontoon.sync.core.update_translated_resources_config')
    def test_with_or_without_project_config(
        self,
        update_translated_resources_config_mock,
        update_translated_resources_no_config_mock,
    ):
        """
        ...
        assert_false(update_translated_resources_config_mock.called)
        assert_true(update_translated_resources_no_config_mock.called)

        # Reset called value
        update_translated_resources_config_mock.called = False
        update_translated_resources_no_config_mock.called = False
        ...
        assert_true(update_translated_resources_config_mock.called)
        assert_false(update_translated_resources_no_config_mock.called)
