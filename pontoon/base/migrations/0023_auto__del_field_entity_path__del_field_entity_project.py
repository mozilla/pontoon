...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('base_entity', 'path')

        # Deleting field 'Entity.project'
        db.delete_column('base_entity', 'project_id')


    def backwards(self, orm):
        # Adding field 'Entity.path'
        db.add_column('base_entity', 'path',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Entity.project'
        raise RuntimeError("Cannot reverse this migration. 'Entity.project' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Entity.project'
        db.add_column('base_entity', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Project']),
                      keep_default=False)
    ...
    models = {
        ...
        'base.entity': {
            ...
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.Resource']", 'null': 'True'}),
