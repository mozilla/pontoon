...
def sync_project(self, project_pk, sync_log_pk, locales=None, no_pull=False, no_commit=False, force=False):
    ...
    # Do not sync resources if locales specified
    if locales:
        obsolete_vcs_entities, obsolete_vcs_resources = None, None
...
def sync_project_repo(self, project_pk, repo_pk, project_sync_log_pk, now, obsolete_vcs_entities=None,
                      obsolete_vcs_resources=None, locales=None, no_pull=False, no_commit=False):
    db_project = get_or_fail(Project, pk=project_pk,
        message='Could not sync project with pk={0}, not found.'.format(project_pk))
    ...
    locales = locales or repo.locales
