...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.quality_checks'
        db.add_column('base_userprofile', 'quality_checks',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.quality_checks'
        db.delete_column('base_userprofile', 'quality_checks')
