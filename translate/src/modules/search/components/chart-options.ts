// Default Time Range chart configuration. Built on demand (rather than once at
// module load) so the chart reads the current theme's CSS variables — this lets
// its colors update when the user switches theme without reloading the page.
