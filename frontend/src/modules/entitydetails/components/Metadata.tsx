...
import { Entity, TermType } from 'core/api';
...
type Props = {
    ...
    readonly commentTabRef: {
        [key: string]: any;
    };
    readonly openLightbox: (arg0: string) => void;
    readonly addTextToEditorTranslation: (arg0: string) => void;
    readonly navigateToPath: (arg0: string) => void;
    setCommentTabIndex: (arg0: number) => void;
    setContactPerson: (arg0: string) => void;
};
...
export default class Metadata extends React.Component<Props, State> {
    ...
    renderSourceObject(source: { [key: string]: any }): React.ReactNode {
    ...
    navigateToPath = (event: React.MouseEvent<HTMLAnchorElement>) => {
