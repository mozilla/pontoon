...
<?php require_once('../../hook/php/pontoon.php'); ?>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
	<?php Pontoon::header_tags('testpilot');?>
		...
		<div id="container">
			...
			<div id="content">
				...
				<div class="button">
					...
					<span class="menuOn"><a href="principles.php"><?php echo _w('Guiding Principles')?></a></span>
				...
				<div id="intro">
					...
					<h2><?php echo _w('Guiding Principles')?></h2>
