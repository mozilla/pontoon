...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('base_project', ['url'])

        # Deleting field 'Project.external'
        db.delete_column('base_project', 'external')

        # Adding field 'Project.width'
        db.add_column('base_project', 'width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.external'
        db.add_column('base_project', 'external',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Project.width'
        db.delete_column('base_project', 'width')

        # Adding unique constraint on 'Project', fields ['url']
        db.create_unique('base_project', ['url'])
