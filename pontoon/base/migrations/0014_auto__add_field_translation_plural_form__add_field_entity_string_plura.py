...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Translation.plural_form'
        db.add_column('base_translation', 'plural_form',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Entity.string_plural'
        db.add_column('base_entity', 'string_plural',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Translation.plural_form'
        db.delete_column('base_translation', 'plural_form')

        # Deleting field 'Entity.string_plural'
        db.delete_column('base_entity', 'string_plural')
