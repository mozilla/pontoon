...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Translation.reviewed'
        db.delete_column('base_translation', 'reviewed')

        # Adding field 'Translation.approved'
        db.add_column('base_translation', 'approved',
    ...
    def backwards(self, orm):
        ...
        db.add_column('base_translation', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Translation.approved'
        db.delete_column('base_translation', 'approved')
