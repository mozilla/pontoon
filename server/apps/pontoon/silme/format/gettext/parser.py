...
from silme.core.list import OrderedEntityList
from silme.core.entity import SimpleEntity
from .structure import GettextStructure, GettextEntity
import re
...
class GettextParser():
    ...
    def parse_to_entitylist(cls, text, code='default'):
        ...
        for match in matchlist:
            if match[0]:
                entityList.add_entity(GettextEntity(match[0], match[1]))
        return entityList
