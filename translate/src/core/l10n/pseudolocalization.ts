...
const ACCENTED_MAP = {
  ...
  caps: [
    550, 385, 391, 7698, 7702, 401, 403, 294, 298, 308, 310, 319, 7742, 544,
    510, 420, 586, 344, 350, 358, 364, 7804, 7814, 7818, 7822, 7824,
  ],
  // ȧƀƈḓḗƒɠħīĵķŀḿƞǿƥɋřşŧŭṽẇẋẏẑ
  small: [
    551, 384, 392, 7699, 7703, 402, 608, 295, 299, 309, 311, 320, 7743, 414,
    511, 421, 587, 345, 351, 359, 365, 7805, 7815, 7819, 7823, 7825,
  ],
};
