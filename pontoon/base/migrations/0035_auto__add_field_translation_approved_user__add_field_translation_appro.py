...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Translation.approved_user'
        db.add_column('base_translation', 'approved_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='approvers', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Translation.approved_date'
        db.add_column('base_translation', 'approved_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Translation.approved_user'
        db.delete_column('base_translation', 'approved_user_id')

        # Deleting field 'Translation.approved_date'
        db.delete_column('base_translation', 'approved_date')
    ...
    models = {
        ...
        'base.translation': {
            ...
            'approved_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'approvers'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'base.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quality_checks': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
