...
``BADGES_PROMOTION_THRESHOLDS``
   Required. A comma-separated list of numeric thresholds for different levels of the 
   Community Builder badge.

``BADGES_START_DATE``
   Required. Specifies the start date from which user activities count towards badge achievements. 
