...
$(function() {
  ...
  $('body')
    .on('mouseenter', '.double-list-selector .select:nth-child(2) li', function (e) { setArrow($(this), e); })
    .on('mousemove', '.double-list-selector .select:nth-child(2) li', function (e) { setArrow($(this), e); });
