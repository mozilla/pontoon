...
urlpatterns = patterns('',
    ...
    url(r'^locale/(?P<locale>[A-Za-z0-9\-\@\.]+)/site/', views.translate_site, name='pontoon.translate.site'),
    url(r'^locale/(?P<locale>[A-Za-z0-9\-\@\.]+)/project/(?P<project>\S+)/$', views.translate_project, name='pontoon.translate.project'),
