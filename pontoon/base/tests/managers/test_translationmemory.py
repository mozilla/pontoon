...
def test_levenshtein_ratio_string_below_255_chars(python_mock, postgresql_mock, tm_entry_short):
...
@patch('pontoon.base.models.TranslationMemoryEntryQuerySet.postgres_levenshtein_ratio')
@patch('pontoon.base.models.TranslationMemoryEntryQuerySet.python_levenshtein_ratio')
def test_levenshtein_ratio_string_equals_255_chars(python_mock, postgresql_mock, tm_entry_medium):
    TranslationMemoryEntry.objects.minimum_levenshtein_ratio(
...
@patch('pontoon.base.models.TranslationMemoryEntryQuerySet.postgres_levenshtein_ratio')
@patch('pontoon.base.models.TranslationMemoryEntryQuerySet.python_levenshtein_ratio')
def test_levenshtein_ratio_string_above_255_chars(python_mock, postgresql_mock, tm_entry_long):
    TranslationMemoryEntry.objects.minimum_levenshtein_ratio(
